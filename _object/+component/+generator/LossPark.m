classdef LossPark < component.generator.abstract
    % 状態・パラメーターはqを先においている
    %edited
    %VとIの関係をedit
    % "LossPark" is for PV_2comp.
    ...
    methods
        function obj = LossPark(parameter)
            arguments
                parameter = 'NGT2';
            end
        ...
        % @@@ 追加部分 @@@
        % Get Method
        function Pload = get.Pload(obj)
            Pload = obj.connected_bus.Pload;
        end
        function Qload = get.Qload(obj)
            Qload = obj.connected_bus.Qload;
        end
        % @@@@@@@@@@@@
