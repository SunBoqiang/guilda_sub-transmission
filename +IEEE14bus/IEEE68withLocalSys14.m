...
%Bus69 Generator & Load
    bus_69 = bus.PV_2machine(0.4,0.217,1.045,shunt);
    net.add_bus(bus_69);
%Bus70 Generator & Load
    bus_70 = bus.PV_2machine(0,0.942,1.01,shunt);
    net.add_bus(bus_70);
%Bus71 PQ Load
...
%Bus73 Synchronous compensators
    bus_73 = bus.PV_2machine(0,0.112,1.07,shunt);
    net.add_bus(bus_73);
%Bus74 Transformer
